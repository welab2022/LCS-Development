                  ...
                  <div className="container-fluid d-flex justify-content-between">
                    ...
                    <div className="position-relative " style={{cursor: 'pointer'}} >
                      <div onClick={togleMyaccount} className="navbar-nav d-flex flex-row" id="account">
                            ...
                            <div  >
                            <p className="my-auto ms-3 "  style={{fontWeight: "bold"}}>{currentUser?currentUser.name:name}</p>
                            <p className="my-auto ms-3 ">{currentUser?currentUser.name:name}</p>
                            </div>                      
                      </div>
      ...
      <div className="my-account">
        <div className='avatar-box d-flex flex-row'>
          ...
          <div className='name-box'>
            <h2 className="my-auto  ">{currentUser?currentUser.name:name}</h2>
      ...
      <div className="account-content">
        ...
        {tab?<div className="profile">
              <table className='table'>
                        ...
                        <tr>
                              <td><b>Name</b></td>
                              <td>{currentUser?currentUser.name:name}</td>
                              <td><td className="btn btn-outline-success p-0">Change</td></td>
                          </tr> 
                          <tr>
                              <td><b>Email</b></td>
                              <td>{currentUser?currentUser.email:email}</td>
