  ...
  return (
    <div id="menu" className=" bg-white menu">
            ...
            <div className="list-group  ">
                ...
                <Link style={{ textDecoration: 'none' }} to="/students"><b className="list-group-item p-3" >Students</b></Link>
                ...
                <Link style={{ textDecoration: 'none' }} to="/classes"><b className="list-group-item p-3">Classes</b></Link>
