...
const ClassForm = () => {
  ...
  return (
    <MainPage>
    <Link to="/classes" className="btn btn-outline-success p-1">Back</Link>
    <div className="container-sm  shadow p-5 " >
        ...
        <div className="mb-3">
            ...
            <div className="mb-3 d-flex" >
              <button id="submit" type="submit" className="btn btn-outline-success w-100">{params.id ==="new"?"Create":"Update"}</button>
